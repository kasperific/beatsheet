    ...
    return (
        <>
            <FaArrowLeft
                ...
                onClick={() => {
                    handleHorizantalScroll(elementRef.current, 25, 200, -7);
                }}
            ...
            />
            <div class="grid overflow-x-scroll justify-start gap-x-8 grid-cols-[repeat(3,300px)] grid-flow-col auto-cols-[300px] w-full" ref={elementRef}>
                {children}
            </div>
        </>
    );
